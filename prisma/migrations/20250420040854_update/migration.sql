/*
  ...
  - Added the required column `nameUnsigned` to the `Product` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "nameUnsigned" TEXT NOT NULL,
